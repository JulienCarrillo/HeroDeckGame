...
#if (UNITY_EDITOR) 
public class CardDataGeneratorFight : MonoBehaviour
{
    ...
    public GameObject FightControllerObject;
    ...
    void Start()
    {
        ...
        //Changer l'url quand l'api sera a jours pour deck fight
        ...
        else
        {
            ...
            for (int i = 0; i <= json.Count - 1; i++)
            {
                ...
                if (cardExist.Count() == 0)
                {
                    ...
                    moveExist1Array = AssetDatabase.FindAssets((string)json[i]["Move2"]["name"], new[] { "Assets/ScriptableObject/Card/MoveData" });
                ...
                FightControllerObject.GetComponent<FightController>().CreateCardPrefab(CardData);
            }
        }
    }
}
