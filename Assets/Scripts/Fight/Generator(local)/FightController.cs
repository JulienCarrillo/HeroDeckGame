...
public class FightController : MonoBehaviour
{
    ...
    public void CreateCardPrefab(CardData CardData)
    {
        ...
        //Prod 
        GameObject CardPrefab = Resources.Load("Assets/Resources/Prefabs/Cards/FightCards/Fight" + CardData.element.name + CardData.element.name + ".prefab", typeof(GameObject)) as GameObject;
