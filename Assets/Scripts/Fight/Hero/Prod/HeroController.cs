...
public class HeroController : MonoBehaviour
{
    ...
    public void HeroMove(Text moveName) 
    {
        ...
        // Local : MoveData move = AssetDatabase.LoadAssetAtPath("Assets/ScriptableObject/Card/MoveData/"+moveName.text+".asset", typeof(MoveData)) as MoveData;
        //Prod
        MoveData move = Resources.Load("ScriptableObjects/Card/MoveData/"+moveName.text, typeof(MoveData)) as MoveData;
